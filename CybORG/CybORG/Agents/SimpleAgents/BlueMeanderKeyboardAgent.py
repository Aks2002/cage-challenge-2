...
class KeyboardAgent(BaseAgent):
    ...
    def _get_valid_commands(self,action_space):
        ...
        #DecoyApache
        current_value = valid_commands['DecoyApache']
        command_value=current_value.pop('command')
        current_value['session'] = [0]
        current_value['agent'] = ['Blue']
        current_value['hostname'] = ['Defender', 'Enterprise0', 'Enterprise1', 'Enterprise2', 'Op_Host0', 'Op_Host1', 'Op_Host2', 'Op_Server0', 'User0', 'User1', 'User2', 'User3', 'User4']
        current_value['command'] = command_value
        valid_commands['DecoyApache'] = current_value

        #DecoyFemitter
        current_value = valid_commands['DecoyFemitter']
        command_value=current_value.pop('command')
        current_value['session'] = [0]
        current_value['agent'] = ['Blue']
        current_value['hostname'] = ['Defender', 'Enterprise0', 'Enterprise1', 'Enterprise2', 'Op_Host0', 'Op_Host1', 'Op_Host2', 'Op_Server0', 'User0', 'User1', 'User2', 'User3', 'User4']
        current_value['command'] = command_value
        valid_commands['DecoyFemitter'] = current_value

        #DecoyHarakaSMPT
        current_value = valid_commands['DecoyHarakaSMPT']
        command_value=current_value.pop('command')
        current_value['session'] = [0]
        current_value['agent'] = ['Blue']
        current_value['hostname'] = ['Defender', 'Enterprise0', 'Enterprise1', 'Enterprise2', 'Op_Host0', 'Op_Host1', 'Op_Host2', 'Op_Server0', 'User0', 'User1', 'User2', 'User3', 'User4']
        current_value['command'] = command_value
        valid_commands['DecoyHarakaSMPT'] = current_value

        #DecoySmss
        current_value = valid_commands['DecoySmss']
        command_value=current_value.pop('command')
        current_value['session'] = [0]
        current_value['agent'] = ['Blue']
        current_value['hostname'] = ['Defender', 'Enterprise0', 'Enterprise1', 'Enterprise2', 'Op_Host0', 'Op_Host1', 'Op_Host2', 'Op_Server0', 'User0', 'User1', 'User2', 'User3', 'User4']
        current_value['command'] = command_value
        valid_commands['DecoySmss'] = current_value

        #DecoySSHD
        current_value = valid_commands['DecoySSHD']
        command_value=current_value.pop('command')
        current_value['session'] = [0]
        current_value['agent'] = ['Blue']
        current_value['hostname'] = ['Defender', 'Enterprise0', 'Enterprise1', 'Enterprise2', 'Op_Host0', 'Op_Host1', 'Op_Host2', 'Op_Server0', 'User0', 'User1', 'User2', 'User3', 'User4']
        current_value['command'] = command_value
        valid_commands['DecoySSHD'] = current_value

        #DecoySvchost
        current_value = valid_commands['DecoySvchost']
        command_value=current_value.pop('command')
        current_value['session'] = [0]
        current_value['agent'] = ['Blue']
        current_value['hostname'] = ['Defender', 'Enterprise0', 'Enterprise1', 'Enterprise2', 'Op_Host0', 'Op_Host1', 'Op_Host2', 'Op_Server0', 'User0', 'User1', 'User2', 'User3', 'User4']
        current_value['command'] = command_value
        valid_commands['DecoySvchost'] = current_value

        #DecoyApache
        current_value = valid_commands['DecoyTomcat']
        command_value=current_value.pop('command')
        current_value['session'] = [0]
        current_value['agent'] = ['Blue']
        current_value['hostname'] = ['Defender', 'Enterprise0', 'Enterprise1', 'Enterprise2', 'Op_Host0', 'Op_Host1', 'Op_Host2', 'Op_Server0', 'User0', 'User1', 'User2', 'User3', 'User4']
        current_value['command'] = command_value
        valid_commands['DecoyTomcat'] = current_value

        #DecoyApache
        current_value = valid_commands['DecoyVsftpd']
        command_value=current_value.pop('command')
        current_value['session'] = [0]
        current_value['agent'] = ['Blue']
        current_value['hostname'] = ['Defender', 'Enterprise0', 'Enterprise1', 'Enterprise2', 'Op_Host0', 'Op_Host1', 'Op_Host2', 'Op_Server0', 'User0', 'User1', 'User2', 'User3', 'User4']
        current_value['command'] = command_value
        valid_commands['DecoyVsftpd'] = current_value
